...
def test_longtail_skill_calls_deterministic_runner():
    ...
    assert "--f32-project-root /workspace/operators/speed_test/LongTail-Bench" in skill
    assert "--f16-project-root /workspace/operators/speed_test/LongTail-Bench-fp16" in skill
