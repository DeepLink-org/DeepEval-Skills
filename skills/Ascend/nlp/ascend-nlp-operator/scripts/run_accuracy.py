#!/usr/bin/env python3
"""Run Ascend accuracy validation while preserving valid failed measurements."""
...
def main() -> int:
    ...
    validator = args.project_root / "npu_op_validate.py"
    ...
    result_json = args.output_dir / "npu_val_result.json"
    result_csv = args.output_dir / "npu_val_result.csv"
